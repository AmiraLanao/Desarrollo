...
public void actualizar(Curso entidad) throws Exception {
	...
	//sql="UPDATE Curso set vchCursNombre='"+entidad.getNombres()+"', vchCursVacante="+entidad.getVacante()+" WHERE chrCursCodigo='"+entidad.getCodigo()+"'";
	
	//sql="UPDATE Curso set vchCursNombre='TM', vchCursVacante=6, vchCursCredito=4 WHERE chrCursCodigo='"+entidad.getCodigo()+"'";
