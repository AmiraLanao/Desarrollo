...
<%
String strCodigoC=request.getParameter("scursoselec");

/*Obeteniendo lista de alumnos*/
Lista objListaA=ALUMNODAO.obtenerAlumnosCUR(strCodigoC);

%>

<html>
<head>
<title>Matricula - Administrador <%=strCodigoC%> <%=((Alumno)objListaA.getElemento(0)).getCodigo()%></title>
</head>
...
<table border="0" width="100%" height="550" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="83%" height="544" valign="top"><font face="Arial"><b>&nbsp;&nbsp;&nbsp;
      ...
      <p align="center"><font size="3"><b>Alumnos Matriculados en el Curo: </b></font></p>
      <div align="center">
        <center>
       ...
       <table border="1" width="86%" height="74">
          <tr>
            ...
            <td width="19%" bgcolor="#f8a5a5" align="center" height="19"><b>Sexo</b></td>
		...
		<%for(int i=0;i<objListaA.getTamanio();i++){%>          
          <tr>
            ...
            <td width="19%" height="18"><%=((Alumno)objListaA.getElemento(i)).getSexo()%></td>
