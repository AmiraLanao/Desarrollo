...
<%
Lista objListaC=CURSODAO.obtenerCurso();
%>
...
<table border="0" width="100%" height="550" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="83%" height="544" valign="top"><font face="Arial"><b>&nbsp;&nbsp;&nbsp;
      ...
      <p align="center"><font size="3"><b>Cosultar Matricula de alumnos por Curso</b></font></p>
      ...
      <div align="center">
	   ...
	   <table border="1" width="86%" height="74">
		...
		<%for(int i=0;i<objListaC.getTamanio();i++){%>          
          <tr>
            <td width="19%" height="18"><%=((Curso)objListaC.getElemento(i)).getCodigo()%></td>
            <td width="36%" height="18"><%=((Curso)objListaC.getElemento(i)).getNombres()%></td>
            <td width="24%" height="18"><%=((Curso)objListaC.getElemento(i)).getVacante()%></td>
            <td width="9%" height="18" align="center">
            	<input type="radio" value="<%=((Curso)objListaC.getElemento(i)).getCodigo()%>" name="scursoselec" <%if(1==i) {%>checked <%}%>> 
            </td>
          </tr>
		<%}%>        
        </table>
