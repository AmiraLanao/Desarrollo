...
<table border="0" width="100%" height="550" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="83%" height="544" valign="top"><font face="Arial"><b>&nbsp;&nbsp;&nbsp;
      ...
      <p align="center"><font size="3"><b>Eliminar Producto Registrado</b></font></p>
        ...
        <div align="center">
          ...
          <table border="0" width="46%" cellpadding="0">
            ...
            <tr>
              ...
              <td width="62%"><input type="text" name="txtNombre" size="20" value="<%=objProducto.getNombres()%>" disabled="true"></td>
            </tr>
            <tr>
              <td width="63%" bgcolor="#f8a5a5">&nbsp;Num. Vacante</td>
              <td width="62%"><input type="text" name="txtVacante" size="20" value="<%=objProducto.getVacante()%>" disabled="true"></td>
            </tr>
          </table>
          </center>
        </div>
