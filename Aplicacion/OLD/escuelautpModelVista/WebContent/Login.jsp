...
body {
	background-image: url(images/imagenDisenio/back.jpg);
}
#apDiv2 {
	position: absolute;
	left: 218px;
...
<div id="apDiv3"><img src="images/imagenDisenio/Loguin.png" width="429" height="334" alt="lgin"></div>
...
<div id="apDiv5">
    ...
    <p>
      <input name="txtLogin" type="text" size="32">
    </p>
    <p>&nbsp;</p>
    <p>
      <input name="txtPassword" type="password" size="32">
    </p>
    <p>
